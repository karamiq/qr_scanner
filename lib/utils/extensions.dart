...
extension DateTimeX on DateTime {
  ...
  String formatTimeago([String? locale]) => timeago.format(this, locale: locale).toUpperCase();
}
...
extension AdditionalColors on ColorScheme {
  ...
  Color get defaultText => AppColors.defaultText;
  Color get otherText => AppColors.otherText;
  Color get successText => AppColors.successText;
  Color get dangerColor => AppColors.dangerColor;
}
